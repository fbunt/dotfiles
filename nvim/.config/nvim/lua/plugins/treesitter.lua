        ...
        config = function()
            require("nvim-treesitter.configs").setup({
                ...
                highlight = {
                    ...
                    -- tree-sitter at the same time. Set this to `true` if you
                    -- depend on 'syntax' being enabled (like for indentation).
                    -- Using this option may slow down your editor, and you may
                    -- see some duplicate highlights. Instead of true it can
